...
.PHONY: help preflight release verify deb rpm test-scripts test-install test-container
...
help:
	...
	@echo 'make test-container         build the image and test it against a real PTY'
